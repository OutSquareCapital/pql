...
def any_value(arg: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `DECIMAL` expression
...
def approx_quantile(x: SqlExpr, pos: SqlExpr) -> SqlExpr:
    ...
    Args:
        x (SqlExpr): `SMALLINT` expression
        pos (SqlExpr): `FLOAT[]` expression
...
def arg_max(arg: SqlExpr, val: SqlExpr, col2: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `ANY` expression
        val (SqlExpr): `ANY` expression
        col2 (SqlExpr | None): `BIGINT` expression
...
def arg_max_null(arg: SqlExpr, val: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `TIMESTAMP` expression
        val (SqlExpr): `HUGEINT` expression
...
def arg_min_null(arg: SqlExpr, val: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `DATE` expression
        val (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
...
def bitstring_agg(
    ...
    Args:
        arg (SqlExpr): `UTINYINT` expression
        col1 (SqlExpr | None): `UTINYINT` expression
        col2 (SqlExpr | None): `UTINYINT` expression
...
def bool_and(arg: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `BOOLEAN` expression
...
def corr(y: SqlExpr, x: SqlExpr) -> SqlExpr:
    ...
    Args:
        y (SqlExpr): `DOUBLE` expression
        x (SqlExpr): `DOUBLE` expression
...
def group_concat(str_arg: SqlExpr, arg: SqlExpr | None = None) -> SqlExpr:
    """Concatenates the column string values with an optional separator.

    Args:
        str_arg (SqlExpr): `ANY` expression
        arg (SqlExpr | None): `VARCHAR` expression
...
def listagg(str_arg: SqlExpr, arg: SqlExpr | None = None) -> SqlExpr:
    """Concatenates the column string values with an optional separator.
...
def max(arg: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
    """Returns the maximum value present in arg.

    Args:
        arg (SqlExpr): `ANY` expression
        col1 (SqlExpr | None): `BIGINT` expression
...
def min(arg: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
...
def quantile(x: SqlExpr, pos: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        x (SqlExpr): `ANY` expression
        pos (SqlExpr | None): `DOUBLE` expression
...
def reservoir_quantile(
    ...
    Args:
        x (SqlExpr): `HUGEINT` expression
        quantile (SqlExpr): `DOUBLE` expression
        sample_size (SqlExpr | None): `INTEGER` expression
...
def array_aggr(list_arg: SqlExpr, function_name: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """Executes the aggregate function `function_name` on the elements of `list`.

    Args:
        list_arg (SqlExpr): `ANY[]` expression
        function_name (SqlExpr): `VARCHAR` expression
...
def array_aggregate(
    list_arg: SqlExpr, function_name: SqlExpr, *args: SqlExpr
) -> SqlExpr:
    """Executes the aggregate function `function_name` on the elements of `list`.
...
def array_cosine_distance(array1: SqlExpr, array2: SqlExpr) -> SqlExpr:
    ...
    Args:
        array1 (SqlExpr): `DOUBLE[ANY]` expression
        array2 (SqlExpr): `DOUBLE[ANY]` expression
...
def array_cross_product(array: SqlExpr, array_2: SqlExpr) -> SqlExpr:
    """Computes the cross product of two arrays of size 3.

    The array elements can not be `NULL`.

    Args:
        array (SqlExpr): `DOUBLE[3]` expression
        array_2 (SqlExpr): `DOUBLE[3]` expression
...
def array_dot_product(array1: SqlExpr, array2: SqlExpr) -> SqlExpr:
    ...
    Args:
        array1 (SqlExpr): `FLOAT[ANY]` expression
        array2 (SqlExpr): `FLOAT[ANY]` expression
...
def array_extract(struct: SqlExpr, index: SqlExpr) -> SqlExpr:
    ...
    Args:
        struct (SqlExpr): `STRUCT` expression
        index (SqlExpr): `BIGINT` expression
...
def array_grade_up(
    list_arg: SqlExpr, col1: SqlExpr | None = None, col2: SqlExpr | None = None
) -> SqlExpr:
    ...
    Args:
        list_arg (SqlExpr): `ANY[]` expression
        col1 (SqlExpr | None): `VARCHAR` expression
        col2 (SqlExpr | None): `VARCHAR` expression
...
def array_length(list_arg: SqlExpr, dimension: SqlExpr | None = None) -> SqlExpr:
    """`array_length` for lists with dimensions other than 1 not implemented.

    Args:
        list_arg (SqlExpr): `ANY[]` expression
        dimension (SqlExpr | None): `BIGINT` expression
...
def array_reverse_sort(list_arg: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
...
def array_select(value_list: SqlExpr, index_list: SqlExpr) -> SqlExpr:
    ...
    Args:
        ...
        index_list (SqlExpr): `BIGINT[]` expression
...
def array_slice(
    list_arg: SqlExpr, begin: SqlExpr, end: SqlExpr, step: SqlExpr | None = None
) -> SqlExpr:
    ...
    Args:
        ...
        step (SqlExpr | None): `BIGINT` expression
...
def array_where(value_list: SqlExpr, mask_list: SqlExpr) -> SqlExpr:
    ...
    Args:
        value_list (SqlExpr): `T[]` expression
        mask_list (SqlExpr): `BOOLEAN[]` expression
...
def bit_and(arg: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `USMALLINT` expression
...
def bit_or(arg: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `UBIGINT` expression
...
def bit_position(substring: SqlExpr, bitstring: SqlExpr) -> SqlExpr:
    ...
    Args:
        substring (SqlExpr): `BIT` expression
        bitstring (SqlExpr): `BIT` expression
...
def bit_xor(arg: SqlExpr) -> SqlExpr:
    ...
    Args:
        arg (SqlExpr): `SMALLINT` expression
...
def from_base64(string: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
...
def from_binary(value: SqlExpr) -> SqlExpr:
    ...
    Args:
        value (SqlExpr): `VARCHAR` expression
...
def from_json(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `VARCHAR` expression
        col1 (SqlExpr): `VARCHAR` expression
...
def to_base(
    ...
    Args:
        number (SqlExpr): `BIGINT` expression
        radix (SqlExpr): `INTEGER` expression
        min_length (SqlExpr | None): `INTEGER` expression
...
def to_binary(string: SqlExpr) -> SqlExpr:
...
def to_centuries(integer: SqlExpr) -> SqlExpr:
    ...
    Args:
        integer (SqlExpr): `INTEGER` expression
...
def to_days(integer: SqlExpr) -> SqlExpr:
    ...
    Args:
        integer (SqlExpr): `BIGINT` expression
...
def to_hex(blob: SqlExpr) -> SqlExpr:
...
def to_milliseconds(double: SqlExpr) -> SqlExpr:
    ...
    Args:
        double (SqlExpr): `DOUBLE` expression
...
def date_diff(part: SqlExpr, startdate: SqlExpr, enddate: SqlExpr) -> SqlExpr:
    ...
    Args:
        part (SqlExpr): `VARCHAR` expression
        startdate (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
        enddate (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
...
def date_part(ts: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `VARCHAR[]` expression
        col1 (SqlExpr): `TIME` expression
...
def date_sub(part: SqlExpr, startdate: SqlExpr, enddate: SqlExpr) -> SqlExpr:
    ...
    Args:
        part (SqlExpr): `VARCHAR` expression
        startdate (SqlExpr): `TIME` expression
        enddate (SqlExpr): `TIME` expression
...
def date_trunc(part: SqlExpr, timestamp: SqlExpr) -> SqlExpr:
    ...
    Args:
        part (SqlExpr): `VARCHAR` expression
        timestamp (SqlExpr): `DATE` expression
...
def json_extract_path(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `VARCHAR` expression
        col1 (SqlExpr): `BIGINT` expression
...
def json_merge_patch(col0: SqlExpr, col1: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """SQL json_merge_patch function.

    Args:
        col0 (SqlExpr): `JSON` expression
        col1 (SqlExpr): `JSON` expression
        *args (SqlExpr): `JSON` expression
...
def json_serialize_plan(
    ...
    Args:
        col0 (SqlExpr): `VARCHAR` expression
        col1 (SqlExpr | None): `BOOLEAN` expression
        col2 (SqlExpr | None): `BOOLEAN` expression
        col3 (SqlExpr | None): `BOOLEAN` expression
        col4 (SqlExpr | None): `BOOLEAN` expression
...
def list_aggr(list_arg: SqlExpr, function_name: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """Executes the aggregate function `function_name` on the elements of `list`.
...
def list_cosine_distance(list1: SqlExpr, list2: SqlExpr) -> SqlExpr:
    ...
    Args:
        list1 (SqlExpr): `DOUBLE[]` expression
        list2 (SqlExpr): `DOUBLE[]` expression
...
def list_cosine_similarity(list1: SqlExpr, list2: SqlExpr) -> SqlExpr:
    ...
    Args:
        list1 (SqlExpr): `FLOAT[]` expression
        list2 (SqlExpr): `FLOAT[]` expression
...
def list_element(list_arg: SqlExpr, index: SqlExpr) -> SqlExpr:
    """Extract the `index`th (1-based) value from the list.

    Args:
        list_arg (SqlExpr): `VARCHAR` expression
        index (SqlExpr): `BIGINT` expression
...
def list_extract(list_arg: SqlExpr, index: SqlExpr) -> SqlExpr:
    """Extract the `index`th (1-based) value from the list.
...
def list_reverse_sort(list_arg: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
    """Sorts the elements of the list in reverse order.
...
def map_from_entries(map_arg: SqlExpr) -> SqlExpr:
    """Returns a map created from the entries of the array.

    Args:
        map_arg (SqlExpr): `STRUCT(K, V)[]` expression
...
def isinf(x: SqlExpr) -> SqlExpr:
    ...
    Args:
        x (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
...
def isodow(ts: SqlExpr) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `INTERVAL` expression
...
def regexp_extract(
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        regex (SqlExpr): `VARCHAR` expression
        name_list (SqlExpr | None): `VARCHAR[]` expression
        options (SqlExpr | None): `VARCHAR` expression
...
def regexp_extract_all(
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        regex (SqlExpr): `VARCHAR` expression
        group (SqlExpr | None): `INTEGER` expression
        options (SqlExpr | None): `VARCHAR` expression
...
def regexp_replace(
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        regex (SqlExpr): `VARCHAR` expression
        replacement (SqlExpr): `VARCHAR` expression
        options (SqlExpr | None): `VARCHAR` expression
...
def add(col0: SqlExpr | None = None, col1: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr | None): `TIMESTAMP WITH TIME ZONE` expression
        col1 (SqlExpr | None): `INTERVAL` expression
...
def age(timestamp: SqlExpr, timestamp_2: SqlExpr | None = None) -> SqlExpr:
    """Subtract arguments, resulting in the time difference between the two timestamps.

    Args:
        timestamp (SqlExpr): `TIMESTAMP` expression
        timestamp_2 (SqlExpr | None): `TIMESTAMP` expression
...
def aggregate(list_arg: SqlExpr, function_name: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """Executes the aggregate function `function_name` on the elements of `list`.
...
def ascii(string: SqlExpr) -> SqlExpr:
...
def at_operator(x: SqlExpr) -> SqlExpr:
    """Absolute value.

    Args:
        x (SqlExpr): `UHUGEINT` expression
...
def bar(
    x: SqlExpr, min_arg: SqlExpr, max_arg: SqlExpr, width: SqlExpr | None = None
) -> SqlExpr:
    ...
    Args:
        x (SqlExpr): `DOUBLE` expression
        min_arg (SqlExpr): `DOUBLE` expression
        max_arg (SqlExpr): `DOUBLE` expression
        width (SqlExpr | None): `DOUBLE` expression
...
def bin(value: SqlExpr) -> SqlExpr:
    """Converts the `value` to binary representation.

    Args:
        value (SqlExpr): `UHUGEINT` expression
...
def bitstring(bitstring: SqlExpr, length: SqlExpr) -> SqlExpr:
    ...
    Args:
        bitstring (SqlExpr): `BIT` expression
        length (SqlExpr): `INTEGER` expression
...
def bitwise_and(left: SqlExpr, right: SqlExpr) -> SqlExpr:
    """Bitwise AND.

    Args:
        left (SqlExpr): `TINYINT` expression
        right (SqlExpr): `TINYINT` expression
...
def bitwise_not(input_arg: SqlExpr) -> SqlExpr:
    """Bitwise NOT.

    Args:
        input_arg (SqlExpr): `TINYINT` expression
...
def bitwise_or(left: SqlExpr, right: SqlExpr) -> SqlExpr:
    """Bitwise OR.

    Args:
        left (SqlExpr): `SMALLINT` expression
        right (SqlExpr): `SMALLINT` expression
...
def bitwise_xor(x: SqlExpr, y: SqlExpr) -> SqlExpr:
...
def century(ts: SqlExpr) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
...
def character_length(string: SqlExpr) -> SqlExpr:
...
def concat_ws(separator: SqlExpr, string: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """Concatenates many strings, separated by `separator`.

    `NULL` inputs are skipped.

    Args:
        separator (SqlExpr): `VARCHAR` expression
        string (SqlExpr): `ANY` expression
        *args (SqlExpr): `ANY` expression
...
def contains(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `MAP(K, V)` expression
...
def current_setting(setting_name: SqlExpr) -> SqlExpr:
    ...
    Args:
        setting_name (SqlExpr): `VARCHAR` expression
...
def currval(sequence_name: SqlExpr) -> SqlExpr:
    ...
    Args:
        sequence_name (SqlExpr): `VARCHAR` expression
...
def damerau_levenshtein(s1: SqlExpr, s2: SqlExpr) -> SqlExpr:
    ...
    Args:
        s1 (SqlExpr): `VARCHAR` expression
        s2 (SqlExpr): `VARCHAR` expression
...
def datediff(part: SqlExpr, startdate: SqlExpr, enddate: SqlExpr) -> SqlExpr:
    ...
    Args:
        part (SqlExpr): `VARCHAR` expression
        startdate (SqlExpr): `DATE` expression
        enddate (SqlExpr): `DATE` expression
...
def datepart(ts: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `VARCHAR[]` expression
        col1 (SqlExpr): `TIME_NS` expression
...
def distance_operator(list1: SqlExpr, list2: SqlExpr) -> SqlExpr:
    """Calculates the Euclidean distance between two points with coordinates given in two inputs lists of equal length.
...
def divide(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `FLOAT` expression
        col1 (SqlExpr): `FLOAT` expression
...
def element_at(map_arg: SqlExpr, key: SqlExpr) -> SqlExpr:
    """Returns a list containing the value for a given key or an empty list if the key is not contained in the map.
...
def ends_with(string: SqlExpr, search_string: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        search_string (SqlExpr): `VARCHAR` expression
...
def epoch(temporal: SqlExpr) -> SqlExpr:
    ...
    Args:
        temporal (SqlExpr): `DATE` expression
...
def epoch_ms(temporal: SqlExpr) -> SqlExpr:
    ...
    Args:
        temporal (SqlExpr): `BIGINT` expression
...
def epoch_ns(temporal: SqlExpr) -> SqlExpr:
    ...
    Args:
        temporal (SqlExpr): `TIME` expression
...
def epoch_us(temporal: SqlExpr) -> SqlExpr:
    ...
    Args:
        temporal (SqlExpr): `TIMESTAMP` expression
...
def equi_width_bins(
    min_arg: SqlExpr, max_arg: SqlExpr, bin_count: SqlExpr, nice_rounding: SqlExpr
) -> SqlExpr:
    ...
    Args:
        ...
        bin_count (SqlExpr): `BIGINT` expression
        nice_rounding (SqlExpr): `BOOLEAN` expression
...
def error(message: SqlExpr) -> SqlExpr:
    ...
    Args:
        message (SqlExpr): `VARCHAR` expression
...
def factorial_postfix(x: SqlExpr) -> SqlExpr:
    """Factorial of x.
...
def floor_divide(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL // function.

    Args:
        col0 (SqlExpr): `TINYINT` expression
        col1 (SqlExpr): `TINYINT` expression
...
def formareadabldecimasize(integer: SqlExpr) -> SqlExpr:
...
def formareadablsize(integer: SqlExpr) -> SqlExpr:
...
def format(format_arg: SqlExpr, *args: SqlExpr) -> SqlExpr:
    """Formats a string using the fmt syntax.

    Args:
        format_arg (SqlExpr): `VARCHAR` expression
        *args (SqlExpr): `ANY` expression
...
def generate_series(
    ...
    Args:
        start (SqlExpr): `TIMESTAMP` expression
        stop (SqlExpr | None): `TIMESTAMP` expression
        step (SqlExpr | None): `INTERVAL` expression
...
def get_bit(bitstring: SqlExpr, index: SqlExpr) -> SqlExpr:
    ...
    Args:
        bitstring (SqlExpr): `BIT` expression
        index (SqlExpr): `INTEGER` expression
...
def ilike_escape(
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        like_specifier (SqlExpr): `VARCHAR` expression
        escape_character (SqlExpr): `VARCHAR` expression
...
def ilike_operator(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL ~~* function.
...
def in_search_path(database_name: SqlExpr, schema_name: SqlExpr) -> SqlExpr:
    ...
    Args:
        database_name (SqlExpr): `VARCHAR` expression
        schema_name (SqlExpr): `VARCHAR` expression
...
def jaro_similarity(
    ...
    Args:
        s1 (SqlExpr): `VARCHAR` expression
        s2 (SqlExpr): `VARCHAR` expression
        score_cutoff (SqlExpr | None): `DOUBLE` expression
...
def json_extract_text(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL ->> function.
...
def left(string: SqlExpr, count: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        count (SqlExpr): `BIGINT` expression
...
def left_shift(input_arg: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """Bitwise shift left.
...
def length(string: SqlExpr) -> SqlExpr:
    """Number of characters in `string`.
...
def like_operator(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL ~~ function.
...
def log(b: SqlExpr, x: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        b (SqlExpr): `DOUBLE` expression
        x (SqlExpr | None): `DOUBLE` expression
...
def lpad(string: SqlExpr, count: SqlExpr, character: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        count (SqlExpr): `INTEGER` expression
        character (SqlExpr): `VARCHAR` expression
...
def ltrim(string: SqlExpr, characters: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        characters (SqlExpr | None): `VARCHAR` expression
...
def make_date(
    ...
    Args:
        year (SqlExpr): `BIGINT` expression
        month (SqlExpr | None): `BIGINT` expression
        day (SqlExpr | None): `BIGINT` expression
...
def make_time(hour: SqlExpr, minute: SqlExpr, seconds: SqlExpr) -> SqlExpr:
    ...
    Args:
        hour (SqlExpr): `BIGINT` expression
        minute (SqlExpr): `BIGINT` expression
        seconds (SqlExpr): `DOUBLE` expression
...
def make_timestamp(
    ...
    Args:
        ...
        month (SqlExpr | None): `BIGINT` expression
        day (SqlExpr | None): `BIGINT` expression
        hour (SqlExpr | None): `BIGINT` expression
        minute (SqlExpr | None): `BIGINT` expression
        seconds (SqlExpr | None): `DOUBLE` expression
...
def make_timestamp_ms(nanos: SqlExpr) -> SqlExpr:
    ...
    Args:
        nanos (SqlExpr): `BIGINT` expression
...
def make_timestamptz(
    ...
    Args:
        col0 (SqlExpr): `BIGINT` expression
        col1 (SqlExpr | None): `BIGINT` expression
        col2 (SqlExpr | None): `BIGINT` expression
        col3 (SqlExpr | None): `BIGINT` expression
        col4 (SqlExpr | None): `BIGINT` expression
        col5 (SqlExpr | None): `DOUBLE` expression
        col6 (SqlExpr | None): `VARCHAR` expression
...
def md5_number(string: SqlExpr) -> SqlExpr:
...
def modulo(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL % function.
...
def normalized_interval(interval: SqlExpr) -> SqlExpr:
    ...
    Args:
        interval (SqlExpr): `INTERVAL` expression
...
def not_ilike_operator(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL !~~* function.
...
def not_like_operator(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL !~~ function.
...
def parse_dirname(path: SqlExpr, separator: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        path (SqlExpr): `VARCHAR` expression
        separator (SqlExpr | None): `VARCHAR` expression
...
def parse_duckdb_log_message(type_arg: SqlExpr, message: SqlExpr) -> SqlExpr:
    """Parse the message into the expected logical type.

    Args:
        type_arg (SqlExpr): `VARCHAR` expression
        message (SqlExpr): `VARCHAR` expression
...
def parse_filename(
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        trim_extension (SqlExpr | None): `BOOLEAN` expression
        separator (SqlExpr | None): `VARCHAR` expression
...
def pow(x: SqlExpr, y: SqlExpr) -> SqlExpr:
    """Computes x to the power of y.
...
def printf(format_arg: SqlExpr, *args: SqlExpr) -> SqlExpr:
...
def range(
    ...
    Args:
        start (SqlExpr): `TIMESTAMP WITH TIME ZONE` expression
        stop (SqlExpr | None): `TIMESTAMP WITH TIME ZONE` expression
        step (SqlExpr | None): `INTERVAL` expression
...
def replace(string: SqlExpr, source: SqlExpr, target: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        source (SqlExpr): `VARCHAR` expression
        target (SqlExpr): `VARCHAR` expression
...
def right_shift(input_arg: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """Bitwise shift right.
...
def round(x: SqlExpr, precision: SqlExpr | None = None) -> SqlExpr:
    """Rounds x to s decimal places.

    Args:
        x (SqlExpr): `DECIMAL` expression
        precision (SqlExpr | None): `INTEGER` expression
...
def set_bit(bitstring: SqlExpr, index: SqlExpr, new_value: SqlExpr) -> SqlExpr:
    ...
    Args:
        bitstring (SqlExpr): `BIT` expression
        index (SqlExpr): `INTEGER` expression
        new_value (SqlExpr): `INTEGER` expression
...
def setseed(col0: SqlExpr) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `DOUBLE` expression
...
def sha256(value: SqlExpr) -> SqlExpr:
...
def similar_to_operator(col0: SqlExpr, col1: SqlExpr) -> SqlExpr:
    """SQL ~~~ function.
...
def spaceship_operator(list1: SqlExpr, list2: SqlExpr) -> SqlExpr:
    """Computes the cosine distance between two same-sized lists.
...
def starts_with_operator(string: SqlExpr, search_string: SqlExpr) -> SqlExpr:
    """Returns `true` if `string` begins with `search_string`.
...
def strftime(data: SqlExpr, format_arg: SqlExpr) -> SqlExpr:
    """Converts a `date` to a string according to the format string.

    Args:
        data (SqlExpr): `TIMESTAMP_NS` expression
        format_arg (SqlExpr): `VARCHAR` expression
...
def strptime(text: SqlExpr, arg2: SqlExpr) -> SqlExpr:
    ...
    Args:
        text (SqlExpr): `VARCHAR` expression
        arg2 (SqlExpr): `VARCHAR[]` expression
...
def substr(string: SqlExpr, start: SqlExpr, length: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        start (SqlExpr): `BIGINT` expression
        length (SqlExpr | None): `BIGINT` expression
...
def subtract(col0: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        col0 (SqlExpr): `UINTEGER` expression
        col1 (SqlExpr | None): `UINTEGER` expression
...
def translate(string: SqlExpr, from_arg: SqlExpr, to: SqlExpr) -> SqlExpr:
    ...
    Args:
        string (SqlExpr): `VARCHAR` expression
        from_arg (SqlExpr): `VARCHAR` expression
        to (SqlExpr): `VARCHAR` expression
...
def trunc(x: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        x (SqlExpr): `UBIGINT` expression
        col1 (SqlExpr | None): `INTEGER` expression
...
def try_strptime(text: SqlExpr, format_arg: SqlExpr) -> SqlExpr:
...
def weekofyear(ts: SqlExpr) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `TIMESTAMP` expression
...
def write_log(string: SqlExpr, *args: SqlExpr) -> SqlExpr:
...
def xor(left: SqlExpr, right: SqlExpr) -> SqlExpr:
    ...
    Args:
        left (SqlExpr): `UTINYINT` expression
        right (SqlExpr): `UTINYINT` expression
...
def struct_extract(struct: SqlExpr, entry: SqlExpr) -> SqlExpr:
    ...
    Args:
        struct (SqlExpr): `STRUCT` expression
        entry (SqlExpr): `BIGINT` expression
...
def string_agg(str_arg: SqlExpr, arg: SqlExpr | None = None) -> SqlExpr:
    """Concatenates the column string values with an optional separator.
...
def time_bucket(
    ...
    Args:
        bucket_width (SqlExpr): `INTERVAL` expression
        timestamp (SqlExpr): `DATE` expression
        origin (SqlExpr | None): `DATE` expression
...
def timetz_byte_comparable(time_tz: SqlExpr) -> SqlExpr:
    ...
    Args:
        time_tz (SqlExpr): `TIME WITH TIME ZONE` expression
...
def timezone(ts: SqlExpr, col1: SqlExpr | None = None) -> SqlExpr:
    ...
    Args:
        ts (SqlExpr): `VARCHAR` expression
        col1 (SqlExpr | None): `TIME WITH TIME ZONE` expression
...
def union_extract(union: SqlExpr, tag: SqlExpr) -> SqlExpr:
    ...
    Args:
        ...
        tag (SqlExpr): `VARCHAR` expression
